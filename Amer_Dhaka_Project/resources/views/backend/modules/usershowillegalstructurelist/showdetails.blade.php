...
@section('page_title','Show Illegal Structure Issue Details')
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><h4 class="mb-0">Illegal Structure Issue Details Status</h4></div>
...
@endif
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">{{ $illegalstructureissue->status }}</div>
                </div>
