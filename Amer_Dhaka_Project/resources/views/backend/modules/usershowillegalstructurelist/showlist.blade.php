...
@section('page_title','Show Illegal Structure Issue Status')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Show Illegal Structure Issue Status</h5>
            </div>
                            ...
                            @forelse ($illegalstructureissue as $issue)
                                <tr>
                                  ...
                                  <td class="text-center">
                                                <a href="{{ route('usershowillegalstructurelist.showdetails', $issue->id) }}"
                                    ...
                                    {{-- Edit --}}
                                    <td class="text-center">
                                        <a href="{{ route('usershowillegalstructurelist.edit', ['id' => $issue->id, 'name' => Str::slug($issue->issue_type)]) }}"
