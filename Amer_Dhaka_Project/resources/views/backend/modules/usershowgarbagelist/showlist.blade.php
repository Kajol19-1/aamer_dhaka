...
@section('page_title','Show Garbage Issue Status')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Show Garbage Issue Status</h5>
            </div>
                            ...
                            @forelse ($garbageissue as $issue)
                                <tr>
                                  ...
                                  <td class="text-center">
                                                <a href="{{ route('usershowgarbagelist.showdetails', $issue->id) }}"
                                    ...
                                    {{-- Edit --}}
                                    <td class="text-center">
                                        <a href="{{ route('usershowgarbagelist.edit', ['id' => $issue->id, 'name' => Str::slug($issue->issue_type)]) }}"
