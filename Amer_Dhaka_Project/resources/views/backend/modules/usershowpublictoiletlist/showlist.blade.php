...
@section('page_title','Show Public Toilet Issue Status')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Show Public Toilet Issue Status</h5>
            </div>
                            ...
                            @forelse ($publictoiletissue as $issue)
                                <tr>
                                  ...
                                  <td class="text-center">
                                                <a href="{{ route('usershowpublictoiletlist.showdetails', $issue->id) }}"
                                    ...
                                    {{-- Edit --}}
                                    <td class="text-center">
                                             <a href="{{ route('usershowpublictoiletlist.edit', ['id' => $issue->id, 'name' => Str::slug($issue->issue_type)]) }}"
